...
public class EncapsulationJavaPractice {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Person has " + h1.getWeight() + " kgs and is " + h1.getHeight() + " meters in height, " +
                "which results in BMI of " + h1.getBmi());
    }
